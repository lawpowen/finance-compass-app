...
class _DashboardV2ScreenState extends ConsumerState<DashboardV2Screen> {
  ...
  Widget build(BuildContext context) {
    ...
    final attentionBudget = budgets.isEmpty ? null : budgets.first;
                  ...
                  children: [
                    ...
                    _AttentionRow(
                      ...
                      subtitle: reminder == null
                          ...
                          : '还款日 ${reminder.dueDate.month}月${reminder.dueDate.day}日',
                      amount: reminder == null
                          ? '—'
                          : compassMoney(due, decimals: 0),
                      color: FinanceColors.compassOrange,
                      badge: reminder == null ? null : '待还款',
                      onTap: reminder == null
                          ? null
