...
- 任一账户、类型或类别筛选变化必须同时更新交易列表、实际消费和信用/贷款口径；“实际现金”的需准备总额保持全月资金需求，并明确说明不随下方筛选缩小。未来贷款月供按完整付款额进入已知现金流出。
...
- 账户页头部旗标和净资产摘要下方的“资产目标”卡都可进入目标页。目标页必须提供新增入口；非空目标卡可编辑和删除，并显示当前总资产趋势、目标金额、进度、剩余金额或首次达成日期。信用卡和贷款负债不得扣减目标进度。
...
- 报表中的“收入/支出”语义统一显示为“现金流入/现金流出”或明确注明实际现金口径；信用卡刷卡不在此重复计出，现金还信用卡和贷款按整笔付款显示。
