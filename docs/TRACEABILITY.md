...
| `features/accounts/asset_goals_page.dart`、`accounts_screen.dart` 目标区块、Repository 与 `AssetService` 资产目标接口 | `SYSTEM_REQUIREMENTS.md`、`MODULE_DESIGN.md`、`DATA_DESIGN.md`、`INTERFACES.md`、`UI_REFERENCE.md`、`TESTING_AND_QUALITY.md`、`CHANGELOG.md` |
...
| `features/accounts/asset_snapshot_form_dialog.dart`、`accounts_screen.dart`、`features/reports/reports_v2_screen.dart` 与投资成本接口 | `SYSTEM_REQUIREMENTS.md`、`MODULE_DESIGN.md`、`DATA_DESIGN.md`、`INTERFACES.md`、`TESTING_AND_QUALITY.md`、`CHANGELOG.md` |
...
| `features/transactions/transactions_v2_screen.dart` 的账户/类型/类别多选面板、`test/transactions_v2_navigation_test.dart` | `SYSTEM_REQUIREMENTS.md`、`ARCHITECTURE.md`、`MODULE_DESIGN.md`、`UI_REFERENCE.md`、`INTERACTION_AUDIT.md`、`TESTING_AND_QUALITY.md`、`CHANGELOG.md` |
