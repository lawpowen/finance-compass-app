...
本文档集与 `Finance Compass 0.9.1+43` 代码同时维护。代码行为为事实来源；计划能力必须明确标注为“计划中”。
...
- [v0.9.1 公开发布 QA（2026-09-24）](public-release-qa-v0.9.1-2026-09-24.md)
...
维护规则见项目根目录的 `AGENTS.md`。修改数据模型、页面流程、业务规则、接口或配置时，必须在同一变更中更新对应文档。
